...
def generate_arrays_from_file1(lines,batch_size):
    ...
    while 1:
        ...
        for b in range(batch_size):
            ...
            # 从文件中读取图像
            img = cv2.imread(r"/home/cv/下载/lixiao/Transfer-Learning-master/VGG16-gcn/data/image/train" + '/' + name)
...
if __name__ == "__main__":
    ...
    # 打开数据集的txt
    with open(r"/home/cv/下载/lixiao/Transfer-Learning-master/VGG16-gcn/data/train.txt","r") as f1:
        lines1 = f1.readlines()
    ...
    # 开始训练
    model.fit_generator(generate_arrays_from_file2(lines2[:num_val], batch_size),
                        steps_per_epoch=max(1, num_val//batch_size),
